...
import { InputForm } from '../../componentes';
...
const Auth = () => {
  ...
  const messageText = isLogin ? 'Necesita una cuenta?' : 'Ya tengo una cuenta!';
  ...
  return (
    <KeyboardAvoidingView style={styles.containerKeyboardAvoidingView} behavior="height">
      <View style={styles.container}>
        <ImageBackground
          source={{
            uri: 'https://images.unsplash.com/photo-1615714571974-773b34093d23?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80',
          }}
